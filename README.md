# Sitecore Countries Item Importer - The Sitecore Countries Importer imports countries as items into Sitecore using values representing ISO codes and country-specific information.
